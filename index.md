...
3. Decipher this person's identity by converting the ASCII hexadecimal codes into their equivalent characters.
    * E. Salt
...
1. Is it possible to write an isntruction using only one address? How would you do this?
...
3. Discuss TWO hardware performance issues that led to the development of multicore computers.

4. Identify TWO popular applications that have successfully exploited multicore computers.
